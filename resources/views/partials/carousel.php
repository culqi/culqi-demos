        ...
        <div class="row">
            ...
            <div class="col-xl pr-xl-2 mb-4 mb-xl-0">
                <div class="bg-img-hero mr-xl-1 height-410-xl max-width-1060-wd max-width-830-xl overflow-hidden"
                    style="background-image: url(./theme/assets/img/1920X422/img1.jpg);">
                    <div class="js-slick-carousel u-slick" data-autoplay="true" data-speed="7000"
                        ...
                        <div class="js-slide bg-img-hero-center">
                            <div class="row height-410-xl py-7 py-md-0 mx-0">
                                ...
                                <div class="col-xl col-6 col-md-6 mt-md-8">
                                    ...
                                    <div class="mb-4" data-scs-animation-in="fadeInUp" data-scs-animation-delay="300">
                                        ...
                                        <div class="font-size-50 font-weight-bold text-lh-45">
                                            <sup class="">S/</sup>749<sup class="">99</sup>
                                        </div>
                                    </div>
                                    <a href="#"
                                ...
                                <div class="col-xl-7 col-6 d-flex align-items-center ml-auto ml-md-0" data-scs-animation-in="zoomIn"
                                    data-scs-animation-delay="500">
                                    <img class="img-fluid" src="./theme/assets/img/500X380/img1.png" alt="Image Description">
                                </div>
                            </div>
                        </div>
                        <div class="js-slide bg-img-hero-center">
                            <div class="row height-410-xl py-7 py-md-0 mx-0">
                                ...
                                <div class="col-xl col-6 col-md-6 mt-md-8">
                                    ...
                                    <h6 class="font-size-15 font-weight-bold mb-3" data-scs-animation-in="slideInLeft" data-scs-animation-delay="200">
                                        UNDER FAVORABLE SMARTWATCHES
                                    </h6>
                                ...
                                <div class="col-xl-7 col-6 d-flex align-items-center ml-auto ml-md-0" data-scs-animation-in="slideInRight"
                                    data-scs-animation-delay="800">
                                    <img class="img-fluid" src="./theme/assets/img/500X380/img2.png" alt="Image Description">
                                </div>
                            </div>
                        </div>
                        <div class="js-slide bg-img-hero-center">
                            <div class="row height-410-xl py-7 py-md-0 mx-0">
                                ...
                                <div class="col-xl-7 col-6 d-flex align-items-center ml-auto ml-md-0" data-scs-animation-in="zoomIn"
                                    data-scs-animation-delay="500">
                                    <img class="img-fluid" src="./theme/assets/img/500X380/img3.png" alt="Image Description">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="overflow-hidden">
                    <ul class="list-unstyled row flex-nowrap flex-xl-wrap overflow-auto overflow-lg-visble mx-n2 mx-xl-0 d-xl-block mb-0">
                        <li class="px-2 px-xl-0 flex-shrink-0 flex-xl-shrink-1 mb-3">
                            <a href="#" class="min-height-126 max-width-320 py-1 py-xl-2 py-wd-1 banner-bg d-flex align-items-center text-gray-90">
                                <div class="col col-lg-6 col-xl-5 col-wd-6 mb-3 mb-lg-0 pr-lg-0">
                                    <img class="img-fluid" src="./theme/assets/img/246X176/img1.jpg" alt="Image Description">
                                </div>
                        ...
                        <li class="px-2 px-xl-0 flex-shrink-0 flex-xl-shrink-1 mb-3">
                            <a href="#" class="min-height-126 max-width-320 py-1 py-xl-2 py-wd-1 banner-bg d-flex align-items-center text-gray-90">
                                <div class="col col-lg-6 col-xl-5 col-wd-6 mb-3 mb-lg-0 pr-lg-0">
                                    <img class="img-fluid" src="./theme/assets/img/246X176/img2.jpg" alt="Image Description">
                                </div>
                                <div class="col col-lg-6 col-xl-7 col-wd-6 pr-xl-4 pr-wd-3">
                                    <div class="mb-2 pb-1 font-size-18 font-weight-light text-ls-n1 text-lh-23">
                        ...
                        <li class="px-2 px-xl-0 flex-shrink-0 flex-xl-shrink-1 mb-0">
                            <a href="#" class="min-height-126 max-width-320 py-1 py-xl-2 py-wd-1 banner-bg d-flex align-items-center text-gray-90">
                                <div class="col col-lg-6 col-xl-5 col-wd-6 mb-3 mb-lg-0 pr-lg-0">
                                    <img class="img-fluid" src="./theme/assets/img/246X176/img3.jpg" alt="Image Description">
                                </div>
                                <div class="col col-lg-6 col-xl-7 col-wd-6 pr-xl-4 pr-wd-3">
                                    <div class="mb-2 pb-1 font-size-18 font-weight-light text-ls-n1 text-lh-23">
                                        CATCH BIG <strong>DEALS</strong> ON THE CAMERAS
