...
class Cards extends Resource {
    ...
    */
    public function getList($options = NULL) {
        return $this->request("GET", self::URL_CARDS . "?limit=5", $api_key = $this->culqi->api_key, $options);
    }
    ...
    */
    public function delete($id = NULL) {
        return $this->request("DELETE", self::URL_CARDS, $api_key = $this->culqi->api_key, NULL, $id);
    }
